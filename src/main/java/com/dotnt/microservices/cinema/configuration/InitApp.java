...
import com.dotnt.microservices.cinema.model.Subscription;
...
import com.dotnt.microservices.cinema.repositories.SubscriptionRepository;
...
//    private String addressApiUrl;
    ...
    ApplicationRunner initApplication() {
        ...
        return args -> {
            ...
            String[] SubscriptionPack = {"MEMBER","VIP", "PREMIUM", "PLATINUM", "TRIAL","FAMILY","STUDENT","BUSINESS"};
            double[] discounts = {0.05, 0.1,0.15,0.2,0,0.12,0.08,0.18};
            List<Subscription> subscriptionList = subscriptionRepository.findAll();
            if(subscriptionList.isEmpty()){
                for (int rowIndex = 0; rowIndex < SubscriptionPack.length; rowIndex++) {
                    Subscription subscription = Subscription
                            .builder()
                            .name(SubscriptionPack[rowIndex])
                            .discount(discounts[rowIndex])
                            .build();
